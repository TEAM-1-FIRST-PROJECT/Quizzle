    ...
    <>
      {filteredUsers && (
        <div className="flex flex-col h-screen overflow-auto">
          <div className="p-4 m-2 md:m-10 border shadow-md rounded bg-gradient-to-br from-violet-400 to-cyan-400 dark:from-zinc-500">
            <input
              type="text"
              className="border p-2 rounded w-full md:w-auto placeholder-orange-300 dark:bg-zinc-400 dark:placeholder-orange-200 font-bold"
              placeholder="Search for user..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
            />
            <div className="mt-4 overflow-x-auto">
              <table className="table-auto rounded w-full text-center bg-gradient-to-br from-indigo-400 to-cyan-400 dark:text-zinc-200 dark:from-zinc-800 text-white">
              ...
              <div className="flex flex-col md:flex-row justify-between items-center mt-4 dark:text-zinc-200">
                <div>
                  Showing {indexOfFirstUser + 1}-{indexOfLastUser} of{" "}
                  {users.length}
                </div>
                <div className="flex justify-center md:justify-end mt-2 md:mt-0">
                  <button
                    className="bg-blue-500 dark:bg-blue-600 dark:hover:bg-blue-700 dark:text-zinc-200 text-white px-4 py-2 rounded mr-2"
                    onClick={() =>
                  ...
                  <button
                    className="bg-blue-500 text-white dark:bg-blue-600 dark:hover:bg-blue-700 dark:text-zinc-200 px-4 py-2 rounded ml-2"
                    onClick={() =>
                      paginate(
