...
const EducatorPanel = () => {
  ...
  return (
    <div className="h-screen pb-20 overflow-auto p-5">
      ...
      <div className="mt-20 justify-center items-center border-4 p-10 rounded-lg bg-gradient-to-br from-indigo-500 to-indigo- dark:bg-gradient-to-br dark:from-zinc-600">
        ...
        <input
          type="text"
          className="border focus-none p-2 placeholder-amber-300 font-bold rounded mb-5 dark:bg-zinc-400 dark:placeholder-orange-200"
