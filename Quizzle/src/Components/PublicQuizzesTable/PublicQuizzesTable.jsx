          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                ...
                <th scope="col" className="px-4 py-3 bg-indigo-500 text-white">Points per question</th>
                <th scope="col" className="px-4 py-3 bg-indigo-500 text-white">Maximum points</th>
                ...
                <th scope="col" className="px-4 py-3 bg-indigo-500 text-white">Questions</th>
                <th scope="col" className="px-4 py-3 bg-indigo-500 text-white">Closes on</th>
              </tr>
            </thead>
