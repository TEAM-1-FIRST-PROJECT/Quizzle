              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      <tr>
                          ...
                          <th scope="col" className="px-4 py-3 bg-indigo-500 text-white">Quiz</th>
                          <th scope="col" className="px-4 py-3 bg-indigo-500 text-white">Category</th>
                          <th scope="col" className="px-4 py-3 bg-indigo-500 text-white">Active users</th>
                          ...
                          <th scope="col" className="px-4 py-3 bg-indigo-500 text-white">Last Update</th>
                      </tr>
                  </thead>
                  <tbody>
                      <tr className="border-b dark:border-indigo-600 hover:bg-indigo-100 dark:hover:bg-indigo-200">
                          ...
                          <td className="px-4 py-2">
                              <span className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-indigo-600 opacity-80 dark:text-white">Desktop PC</span>
                          </td>
                          ...
                          <td className="px-4 py-2 text-white">$3.2M</td>
                      ...
                      <tr className="border-b dark:border-indigo-600 hover:bg-indigo-100 dark:hover:bg-indigo-200">
                          ...
                          <td className="px-4 py-2 text-white">$785K</td>
                      ...
                      <tr className="border-b dark:border-indigo-600 hover:bg-indigo-100 dark:hover:bg-indigo-200">
                          ...
                          <th scope="row" className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <img src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/apple-iphone-14.png" alt="iMac Front Image" className="w-auto h-8 mr-3"></img>
                              Apple iPhone 14
                          </th>
                          <td className="px-4 py-2">
                              <span className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-indigo-600 opacity-80 dark:text-white">Phone</span>
                          </td>
                          <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <div className="flex items-center">
                      ...
                      <tr className="border-b dark:border-indigo-600 hover:bg-indigo-100 dark:hover:bg-indigo-200">
                          ...
                          <th scope="row" className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <img src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/apple-ipad-air.png" alt="iMac Front Image" className="w-auto h-8 mr-3"></img>
                              Apple iPad Air
                          </th>
                          <td className="px-4 py-2">
                              <span className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-indigo-600 opacity-80 dark:text-white">Tablet</span>
                          </td>
                          <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <div className="flex items-center">
                          ...
                          <td className="px-4 py-2 text-white">$425K</td>
                          <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">Just now</td>
                      </tr>
                      <tr className="border-b dark:border-indigo-600 hover:bg-indigo-100 dark:hover:bg-indigo-200">
                          <td className="w-4 px-4 py-3">
                          ...
                          <th scope="row" className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <img src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/xbox-series-s.png" alt="iMac Front Image" className="w-auto h-8 mr-3"></img>
                              Xbox Series S
                          </th>
                          <td className="px-4 py-2">
                              <span className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-indigo-600 opacity-80 dark:text-white">Console</span>
                          </td>
                          <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <div className="flex items-center">
                          ...
                          <td className="px-4 py-2 text-white">$345K</td>
                          <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">This week</td>
                      </tr>
                      <tr className="border-b dark:border-indigo-600 hover:bg-indigo-100 dark:hover:bg-indigo-200">
                          <td className="w-4 px-4 py-3">
                          ...
                          <th scope="row" className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <img src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/playstation-5.png" alt="iMac Front Image" className="w-auto h-8 mr-3"></img>
                              PlayStation 5
                          </th>
                          <td className="px-4 py-2">
                              <span className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-indigo-600 opacity-80 dark:text-white">Console</span>
                          ...
                          <td className="px-4 py-2 text-white">$4.2M</td>
                          <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">This week</td>
                      </tr>
                      <tr className="border-b dark:border-indigo-600 hover:bg-indigo-100 dark:hover:bg-indigo-200">
                          <td className="w-4 px-4 py-3">
                          ...
                          <th scope="row" className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <img src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/xbox-series-x.png" alt="iMac Front Image" className="w-auto h-8 mr-3"></img>
                              Xbox Series X
                          </th>
                          <td className="px-4 py-2">
                              <span className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-indigo-600 opacity-80 dark:text-white">Gaming/Console</span>
                          </td>
                          <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <div className="flex items-center">
                          ...
                          <td className="px-4 py-2 text-white">$2.27M</td>
                          <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">This week</td>
                      </tr>
                      <tr className="border-b dark:border-indigo-600 hover:bg-indigo-100 dark:hover:bg-indigo-200">
                          <td className="w-4 px-4 py-3">
                          ...
                          <th scope="row" className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <img src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/apple-watch-se.png" alt="iMac Front Image" className="w-auto h-8 mr-3"></img>
                              Apple Watch SE
                          </th>
                          <td className="px-4 py-2">
                              <span className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-indigo-600 opacity-80 dark:text-white">Watch</span>
                          </td>
                          <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <div className="flex items-center">
                                  <div className="inline-block w-4 h-4 mr-2 bg-yellow-300 rounded-full"></div>
                          ...
                          <td className="px-4 py-2 text-white">$45K</td>
                      ...
                      <tr className="border-b dark:border-indigo-600 hover:bg-indigo-100 dark:hover:bg-indigo-200">
                          ...
                          <th scope="row" className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <img src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/nikon-d850.png" alt="iMac Front Image" className="w-auto h-8 mr-3"></img>
                              NIKON D850
                          </th>
                          <td className="px-4 py-2">
                              <span className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-indigo-600 opacity-80 dark:text-white">Photo/Video</span>
                          </td>
                          <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <div className="flex items-center">
                          ...
                          <td className="px-4 py-2 text-white">$1.52M</td>
                      ...
                      <tr className="border-b dark:border-indigo-600 hover:bg-indigo-100 dark:hover:bg-indigo-200">
                          ...
                          <th scope="row" className="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <img src="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/benq-ex2710q.png" alt="iMac Front Image" className="w-auto h-8 mr-3"></img>
                              Monitor BenQ EX2710Q
                          </th>
                          <td className="px-4 py-2">
                              <span className="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-indigo-600 opacity-80 dark:text-white">TV/Monitor</span>
                          </td>
                          <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <div className="flex items-center">
                          ...
                          <td className="px-4 py-2 text-white">$1.2M</td>
                          <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">Just now</td>
                      </tr>
                  </tbody>
              </table>
